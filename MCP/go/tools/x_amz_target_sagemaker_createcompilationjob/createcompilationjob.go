...
func CreatecompilationjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateCompilationJobRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateCompilationJob", cfg.BaseURL)
		...
		var result models.CreateCompilationJobResponse
...
func CreateCreatecompilationjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_CreateCompilationJob",
		...
		mcp.WithString("InputConfig", mcp.Description("")),
		mcp.WithString("ModelPackageVersionArn", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatecompilationjobHandler(cfg),
	}
}
