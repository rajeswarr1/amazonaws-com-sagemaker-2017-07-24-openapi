...
func ListdevicefleetsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListDeviceFleetsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListDeviceFleets%s", cfg.BaseURL, queryString)
		...
		var result models.ListDeviceFleetsResponse
...
func CreateListdevicefleetsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListDeviceFleets",
		mcp.WithDescription("Returns a list of devices in the fleet."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListdevicefleetsHandler(cfg),
	}
}
