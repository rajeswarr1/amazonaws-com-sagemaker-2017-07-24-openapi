...
func Createautomljobv2Handler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateAutoMLJobV2Request
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateAutoMLJobV2", cfg.BaseURL)
		...
		var result models.CreateAutoMLJobV2Response
...
func CreateCreateautomljobv2Tool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_CreateAutoMLJobV2",
		...
		mcp.WithString("AutoMLJobInputDataConfig", mcp.Required(), mcp.Description("")),
		mcp.WithString("DataSplitConfig", mcp.Description("")),
		...
		mcp.WithString("AutoMLProblemTypeConfig", mcp.Required(), mcp.Description("")),
		mcp.WithString("ModelDeployConfig", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Createautomljobv2Handler(cfg),
	}
}
