...
func CreateartifactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateArtifactRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateArtifact", cfg.BaseURL)
		...
		var result models.CreateArtifactResponse
...
func CreateCreateartifactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_CreateArtifact",
		...
		mcp.WithString("ArtifactType", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateartifactHandler(cfg),
	}
}
