...
func ListmodelsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListModelsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListModels%s", cfg.BaseURL, queryString)
		...
		var result models.ListModelsOutput
...
func CreateListmodelsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListModels",
		mcp.WithDescription("Lists models created with the <code>CreateModel</code> API."),
