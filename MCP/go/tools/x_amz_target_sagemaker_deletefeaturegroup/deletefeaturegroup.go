...
func DeletefeaturegroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteFeatureGroupRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.DeleteFeatureGroup", cfg.BaseURL)
...
func CreateDeletefeaturegroupTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletefeaturegroupHandler(cfg),
	}
}
