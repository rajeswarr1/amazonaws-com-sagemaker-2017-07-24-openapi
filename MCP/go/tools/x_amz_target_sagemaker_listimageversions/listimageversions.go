...
func ListimageversionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListImageVersionsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListImageVersions%s", cfg.BaseURL, queryString)
		...
		var result models.ListImageVersionsResponse
...
func CreateListimageversionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListImageVersions",
		mcp.WithDescription("Lists the versions of a specified image and their properties. The list can be filtered by creation time or modified time."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListimageversionsHandler(cfg),
	}
}
