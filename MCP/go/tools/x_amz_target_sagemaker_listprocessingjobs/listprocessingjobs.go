...
func ListprocessingjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListProcessingJobsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListProcessingJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListProcessingJobsResponse
...
func CreateListprocessingjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListProcessingJobs",
		mcp.WithDescription("Lists processing jobs that satisfy various filters."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListprocessingjobsHandler(cfg),
	}
}
