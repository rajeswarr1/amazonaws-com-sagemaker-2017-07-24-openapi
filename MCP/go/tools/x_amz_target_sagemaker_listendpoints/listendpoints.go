...
func ListendpointsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListEndpointsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListEndpoints%s", cfg.BaseURL, queryString)
		...
		var result models.ListEndpointsOutput
...
func CreateListendpointsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListEndpoints",
		mcp.WithDescription("Lists endpoints."),
