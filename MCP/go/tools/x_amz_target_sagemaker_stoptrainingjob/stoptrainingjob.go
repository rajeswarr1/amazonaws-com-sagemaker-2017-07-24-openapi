...
func StoptrainingjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.StopTrainingJobRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.StopTrainingJob", cfg.BaseURL)
...
func CreateStoptrainingjobTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    StoptrainingjobHandler(cfg),
	}
}
