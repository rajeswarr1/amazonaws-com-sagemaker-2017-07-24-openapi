...
func DescribetrainingjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeTrainingJobRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.DescribeTrainingJob", cfg.BaseURL)
		...
		var result models.DescribeTrainingJobResponse
...
func CreateDescribetrainingjobTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribetrainingjobHandler(cfg),
	}
}
