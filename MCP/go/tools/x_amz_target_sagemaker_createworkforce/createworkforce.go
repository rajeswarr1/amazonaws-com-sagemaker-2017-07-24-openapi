...
func CreateworkforceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateWorkforceRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateWorkforce", cfg.BaseURL)
		...
		var result models.CreateWorkforceResponse
