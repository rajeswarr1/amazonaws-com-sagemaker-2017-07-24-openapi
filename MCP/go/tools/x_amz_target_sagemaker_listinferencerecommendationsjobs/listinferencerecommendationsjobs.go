...
func ListinferencerecommendationsjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListInferenceRecommendationsJobsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListInferenceRecommendationsJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListInferenceRecommendationsJobsResponse
...
func CreateListinferencerecommendationsjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListInferenceRecommendationsJobs",
		mcp.WithDescription("Lists recommendation jobs that satisfy various filters."),
		...
		mcp.WithString("ModelNameEquals", mcp.Description("")),
		mcp.WithString("ModelPackageVersionArnEquals", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListinferencerecommendationsjobsHandler(cfg),
	}
}
