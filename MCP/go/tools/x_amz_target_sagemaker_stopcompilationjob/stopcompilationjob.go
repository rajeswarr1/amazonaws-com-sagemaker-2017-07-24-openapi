...
func StopcompilationjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.StopCompilationJobRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.StopCompilationJob", cfg.BaseURL)
...
func CreateStopcompilationjobTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    StopcompilationjobHandler(cfg),
	}
}
