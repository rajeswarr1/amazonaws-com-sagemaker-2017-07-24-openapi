...
func DescribeimageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeImageRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.DescribeImage", cfg.BaseURL)
		...
		var result models.DescribeImageResponse
...
func CreateDescribeimageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_DescribeImage",
		mcp.WithDescription("Describes a SageMaker image."),
