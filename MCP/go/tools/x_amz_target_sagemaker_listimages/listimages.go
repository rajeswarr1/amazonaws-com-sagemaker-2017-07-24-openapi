...
func ListimagesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListImagesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListImages%s", cfg.BaseURL, queryString)
		...
		var result models.ListImagesResponse
...
func CreateListimagesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListImages",
		mcp.WithDescription("Lists the images in your account and their properties. The list can be filtered by creation time or modified time, and whether the image name contains a specified string."),
