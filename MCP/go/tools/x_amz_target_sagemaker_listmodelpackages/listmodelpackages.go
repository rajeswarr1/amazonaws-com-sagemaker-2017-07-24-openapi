...
func ListmodelpackagesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListModelPackagesInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListModelPackages%s", cfg.BaseURL, queryString)
		...
		var result models.ListModelPackagesOutput
...
func CreateListmodelpackagesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListModelPackages",
		mcp.WithDescription("Lists the model packages that have been created."),
		...
		mcp.WithString("ModelPackageType", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListmodelpackagesHandler(cfg),
	}
}
