...
func ListcompilationjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListCompilationJobsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListCompilationJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListCompilationJobsResponse
...
func CreateListcompilationjobsTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListcompilationjobsHandler(cfg),
	}
}
