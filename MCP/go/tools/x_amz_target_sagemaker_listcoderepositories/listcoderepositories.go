...
func ListcoderepositoriesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListCodeRepositoriesInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListCodeRepositories%s", cfg.BaseURL, queryString)
		...
		var result models.ListCodeRepositoriesOutput
...
func CreateListcoderepositoriesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListCodeRepositories",
		mcp.WithDescription("Gets a list of the Git repositories in your account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListcoderepositoriesHandler(cfg),
	}
}
