...
func ListprojectsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListProjectsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListProjects%s", cfg.BaseURL, queryString)
		...
		var result models.ListProjectsOutput
...
func CreateListprojectsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListProjects",
		mcp.WithDescription("Gets a list of the projects in an Amazon Web Services account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListprojectsHandler(cfg),
	}
}
