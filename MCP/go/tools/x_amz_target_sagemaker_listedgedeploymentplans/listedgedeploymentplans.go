...
func ListedgedeploymentplansHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListEdgeDeploymentPlansRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListEdgeDeploymentPlans%s", cfg.BaseURL, queryString)
		...
		var result models.ListEdgeDeploymentPlansResponse
...
func CreateListedgedeploymentplansTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListEdgeDeploymentPlans",
		mcp.WithDescription("Lists all edge deployment plans."),
		...
		mcp.WithString("DeviceFleetNameContains", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListedgedeploymentplansHandler(cfg),
	}
}
