...
func ListartifactsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListArtifactsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListArtifacts%s", cfg.BaseURL, queryString)
...
func CreateListartifactsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListArtifacts",
		mcp.WithDescription("Lists the artifacts in your account and their properties."),
		...
		mcp.WithString("ArtifactType", mcp.Description("")),
