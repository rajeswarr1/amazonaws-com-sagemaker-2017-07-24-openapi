...
func ListhubsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListHubsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListHubs", cfg.BaseURL)
		...
		var result models.ListHubsResponse
...
func CreateListhubsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListHubs",
		mcp.WithDescription("<p>List all existing hubs.</p> <note> <p>Hub APIs are only callable through SageMaker Studio.</p> </note>"),
