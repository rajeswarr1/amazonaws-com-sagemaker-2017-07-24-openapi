...
func ListpipelinesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListPipelinesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListPipelines%s", cfg.BaseURL, queryString)
...
func CreateListpipelinesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListPipelines",
		mcp.WithDescription("Gets a list of pipelines."),
		...
		mcp.WithString("PipelineNamePrefix", mcp.Description("")),
