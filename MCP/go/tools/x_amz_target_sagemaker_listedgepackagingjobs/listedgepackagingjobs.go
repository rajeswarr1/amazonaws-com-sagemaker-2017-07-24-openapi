...
func ListedgepackagingjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListEdgePackagingJobsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListEdgePackagingJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListEdgePackagingJobsResponse
...
func CreateListedgepackagingjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListEdgePackagingJobs",
		mcp.WithDescription("Returns a list of edge packaging jobs."),
		...
		mcp.WithString("ModelNameContains", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListedgepackagingjobsHandler(cfg),
	}
}
