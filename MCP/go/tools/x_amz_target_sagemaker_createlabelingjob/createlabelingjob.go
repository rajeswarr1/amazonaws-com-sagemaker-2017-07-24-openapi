...
func CreatelabelingjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateLabelingJobRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateLabelingJob", cfg.BaseURL)
		...
		var result models.CreateLabelingJobResponse
...
func CreateCreatelabelingjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_CreateLabelingJob",
		...
		mcp.WithString("LabelAttributeName", mcp.Required(), mcp.Description("")),
		mcp.WithString("LabelCategoryConfigS3Uri", mcp.Description("")),
		mcp.WithString("LabelingJobName", mcp.Required(), mcp.Description("")),
		mcp.WithString("LabelingJobAlgorithmsConfig", mcp.Description("")),
		...
		mcp.WithString("HumanTaskConfig", mcp.Required(), mcp.Description("")),
		mcp.WithString("OutputConfig", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreatelabelingjobHandler(cfg),
	}
}
