...
func ListendpointconfigsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListEndpointConfigsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListEndpointConfigs%s", cfg.BaseURL, queryString)
		...
		var result models.ListEndpointConfigsOutput
...
func CreateListendpointconfigsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListEndpointConfigs",
		mcp.WithDescription("Lists endpoint configurations."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListendpointconfigsHandler(cfg),
	}
}
