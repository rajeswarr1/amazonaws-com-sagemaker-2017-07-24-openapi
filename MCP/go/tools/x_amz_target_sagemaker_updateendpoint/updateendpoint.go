...
func UpdateendpointHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateEndpointInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.UpdateEndpoint", cfg.BaseURL)
		...
		var result models.UpdateEndpointOutput
...
func CreateUpdateendpointTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateendpointHandler(cfg),
	}
}
