...
func AddtagsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.AddTagsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.AddTags", cfg.BaseURL)
		...
		var result models.AddTagsOutput
