...
func ListmodelpackagegroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListModelPackageGroupsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListModelPackageGroups%s", cfg.BaseURL, queryString)
		...
		var result models.ListModelPackageGroupsOutput
...
func CreateListmodelpackagegroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListModelPackageGroups",
		mcp.WithDescription("Gets a list of the model groups in your Amazon Web Services account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListmodelpackagegroupsHandler(cfg),
	}
}
