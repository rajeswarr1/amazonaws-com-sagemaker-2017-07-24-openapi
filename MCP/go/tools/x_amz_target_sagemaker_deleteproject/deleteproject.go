...
func DeleteprojectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteProjectInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.DeleteProject", cfg.BaseURL)
...
func CreateDeleteprojectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_DeleteProject",
		mcp.WithDescription("Delete the specified project."),
