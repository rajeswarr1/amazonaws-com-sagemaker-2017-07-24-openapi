...
func ListlabelingjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListLabelingJobsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListLabelingJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListLabelingJobsResponse
...
func CreateListlabelingjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListLabelingJobs",
		mcp.WithDescription("Gets a list of labeling jobs."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListlabelingjobsHandler(cfg),
	}
}
