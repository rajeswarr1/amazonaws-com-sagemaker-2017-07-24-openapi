...
func ListmodelcardsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListModelCardsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListModelCards%s", cfg.BaseURL, queryString)
		...
		var result models.ListModelCardsResponse
...
func CreateListmodelcardsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListModelCards",
		mcp.WithDescription("List existing model cards."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListmodelcardsHandler(cfg),
	}
}
