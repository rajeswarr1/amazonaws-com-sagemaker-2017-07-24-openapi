...
func ListtransformjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListTransformJobsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListTransformJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListTransformJobsResponse
...
func CreateListtransformjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListTransformJobs",
		mcp.WithDescription("Lists transform jobs."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListtransformjobsHandler(cfg),
	}
}
