...
func UpdateprojectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateProjectInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.UpdateProject", cfg.BaseURL)
		...
		var result models.UpdateProjectOutput
