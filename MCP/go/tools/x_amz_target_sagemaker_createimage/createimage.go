...
func CreateimageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateImageRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateImage", cfg.BaseURL)
		...
		var result models.CreateImageResponse
...
func CreateCreateimageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_CreateImage",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateimageHandler(cfg),
	}
}
