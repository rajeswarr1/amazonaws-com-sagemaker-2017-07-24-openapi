...
func ListmonitoringschedulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListMonitoringSchedulesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListMonitoringSchedules%s", cfg.BaseURL, queryString)
		...
		var result models.ListMonitoringSchedulesResponse
...
func CreateListmonitoringschedulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListMonitoringSchedules",
		mcp.WithDescription("Returns list of all monitoring schedules."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListmonitoringschedulesHandler(cfg),
	}
}
