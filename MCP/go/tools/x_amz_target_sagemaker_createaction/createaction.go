...
func CreateactionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateActionRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateAction", cfg.BaseURL)
		...
		var result models.CreateActionResponse
...
func CreateCreateactionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_CreateAction",
		...
		mcp.WithString("ActionType", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateactionHandler(cfg),
	}
}
