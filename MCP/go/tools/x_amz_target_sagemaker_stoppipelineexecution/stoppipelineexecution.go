...
func StoppipelineexecutionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.StopPipelineExecutionRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.StopPipelineExecution", cfg.BaseURL)
		...
		var result models.StopPipelineExecutionResponse
...
func CreateStoppipelineexecutionTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    StoppipelineexecutionHandler(cfg),
	}
}
