...
func ListinferenceexperimentsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListInferenceExperimentsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListInferenceExperiments%s", cfg.BaseURL, queryString)
		...
		var result models.ListInferenceExperimentsResponse
...
func CreateListinferenceexperimentsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListInferenceExperiments",
		mcp.WithDescription("Returns the list of all inference experiments."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListinferenceexperimentsHandler(cfg),
	}
}
