...
func ListalgorithmsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListAlgorithmsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListAlgorithms%s", cfg.BaseURL, queryString)
		...
		var result models.ListAlgorithmsOutput
...
func CreateListalgorithmsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListAlgorithms",
		mcp.WithDescription("Lists the machine learning algorithms that have been created."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListalgorithmsHandler(cfg),
	}
}
