...
func ListautomljobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListAutoMLJobsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.ListAutoMLJobs%s", cfg.BaseURL, queryString)
		...
		var result models.ListAutoMLJobsResponse
...
func CreateListautomljobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_ListAutoMLJobs",
		mcp.WithDescription("Request a list of jobs."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListautomljobsHandler(cfg),
	}
}
