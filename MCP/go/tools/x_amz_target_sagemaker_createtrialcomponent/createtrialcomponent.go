...
func CreatetrialcomponentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateTrialComponentRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=SageMaker.CreateTrialComponent", cfg.BaseURL)
		...
		var result models.CreateTrialComponentResponse
...
func CreateCreatetrialcomponentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=SageMaker_CreateTrialComponent",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatetrialcomponentHandler(cfg),
	}
}
